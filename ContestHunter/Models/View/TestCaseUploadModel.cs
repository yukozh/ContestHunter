...
namespace ContestHunter.Models.View
{
    public class TestCaseUploadModel
    {
        ...
        [Display(Name = "测试数据压缩包", Description = @"请将所有数据，压缩为一个<b>.zip</b>文件。<br/>所有输入文件名应类似 <b>Bala1.in</b>（或.input）。<br/>所有输出文件名应类似 <b>Bala1.out</b>（或.ou .output）。<br/>输入文件和输出文件应按编号一一对应。<br/>请不要在压缩包内包含其他无关文件。")]
